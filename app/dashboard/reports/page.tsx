  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Comprehensive insights and compliance documentation
            </p>
          </div>
          ...
          {metrics.map((metric, i) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className={`w-12 h-12 bg-gradient-to-br ${metric.gradient} rounded-xl flex items-center justify-center`}
                >
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-xl font-bold text-gray-900 mb-6">
            6-Month Efficiency & Cost Savings
          </h2>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reportTemplates.map((template, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 bg-${template.color}-100 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
                  <template.icon
                ...
                <button
                  className={`w-full py-2 bg-${template.color}-50 text-${template.color}-700 rounded-lg font-semibold hover:bg-${template.color}-100 transition-all flex items-center justify-center gap-2`}
                >
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-green-100">
                Your contribution to sustainability goals
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900">
                  All Reports Blockchain-Verified
                </h3>
                <p className="text-gray-600">
                  Every data point is cryptographically secured and
                  tamper-proof
                </p>
              </div>
            </div>
