      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your cleaning team and track performance</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl p-4 shadow">
            <p className="text-gray-600 text-sm mb-1">Active Today</p>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center text-white font-bold text-lg">
                    {member.avatar}
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className={`px-3 py-1 rounded-lg text-xs font-semibold ${getStatusBadge(member.status)}`}>
                  {member.status}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-blue-50 rounded-lg p-3">
                  ...
                  <p className="text-lg font-bold text-gray-900">{member.performance.thisWeek}</p>
                </div>
                <div className="bg-green-50 rounded-lg p-3">
                  <p className="text-xs text-gray-600 mb-1">Efficiency</p>
                  <p className="text-lg font-bold text-gray-900">{member.efficiency}%</p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {[...teamMembers]
              .sort((a, b) => b.performance.thisMonth - a.performance.thisMonth)
              .slice(0, 5)
              .map((member, index) => (
                <div key={member.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-gray-900">{member.performance.thisMonth} tasks</p>
                    <p className="text-sm text-gray-600">{member.performance.quality}% quality</p>
                  </div>
                </div>
              ))}
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          {/* Attendance */}
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Attendance This Week</h2>
            <div className="space-y-3">
              {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map((day, i) => (
                <div key={i} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">{teamMembers.filter(m => m.status === 'active').length}/{teamMembers.length}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setSelectedMember(null)}>
          <div className="bg-white rounded-3xl p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center text-white font-bold text-2xl">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className={`ml-2 px-3 py-1 rounded-lg text-xs font-semibold ${getStatusBadge(selectedMember.status)}`}>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <h3 className="font-bold text-gray-900 mb-2">Specialization</h3>
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              <div className="bg-blue-50 rounded-xl p-4 text-center">
                ...
                <p className="text-2xl font-bold text-blue-600">{selectedMember.performance.thisWeek}</p>
              </div>
              <div className="bg-green-50 rounded-xl p-4 text-center">
                <p className="text-sm text-gray-600 mb-1">This Month</p>
                <p className="text-2xl font-bold text-green-600">{selectedMember.performance.thisMonth}</p>
              </div>
              <div className="bg-purple-50 rounded-xl p-4 text-center">
                <p className="text-sm text-gray-600 mb-1">Avg Time</p>
                <p className="text-2xl font-bold text-purple-600">{selectedMember.performance.avgTime}</p>
              </div>
              <div className="bg-orange-50 rounded-xl p-4 text-center">
                <p className="text-sm text-gray-600 mb-1">Quality</p>
                <p className="text-2xl font-bold text-orange-600">{selectedMember.performance.quality}%</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <button className="px-6 py-3 text-gray-700 border-2 border-gray-300 rounded-xl font-semibold hover:bg-gray-50 transition-colors">
                View Full History
              </button>
            </div>
          </div>
